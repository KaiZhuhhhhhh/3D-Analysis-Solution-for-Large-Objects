...
void pointCloud::loadPointCloud(const string fileName,
...
void pointCloud::downSample(pcl::PointCloud<PointT>::Ptr &cloud,
...
void pointCloud::filterPointCloud(pcl::PointCloud<PointT>::Ptr &original_cloud,
...
void pointCloud::showPointCloud(pcl::PointCloud<PointT>::Ptr &cloud,  string windowName)
{
...
void pointCloud::showCompare2PointCloud(pcl::PointCloud<PointT>::Ptr &cloud1,
